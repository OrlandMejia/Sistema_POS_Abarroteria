...
@section('content')
    ...
    <div class="container-fluid px-4">
        <h1 class="mt-4 text-center">Categorias Registradas</h1>
                ...
                <table id="datatablesSimple" class="table table-striped" style="border-collapse: collapse;">
                    ...
                    <tbody>
                        @foreach ($categorias as $categoria)
                                    ...
                                    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                        ...
                                        @if ($categoria->caracteristica->estado == 1)
                                            <button type="button" class="btn btn-danger"
                                                ...
                                                data-bs-target="#confirmacion-{{ $categoria->id }}">
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="confirmacion-{{ $categoria->id }}" tabindex="-1"
